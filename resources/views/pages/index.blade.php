...
@section('header_text')
        <div class="header-text">
            <h1 style="font-weight:600">A WALK TO CHANGE</h1>
            <p style="max-width: 642px; margin: 20px auto 30px;">Prochesta Foundation aims at the upliftment & betterment of people living below the poverty line.
...
<section id="services" style="padding: 60px 0px 100px;">
   <div class="container">
        <div class="row  ">
          <h1 class="quest-header">SERVICES</h1>
         <div class="horizontal-line">
									<hr>
         </div>
         <p class="quest-paragraph" style="max-width: 707px;
    margin: 0px auto;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod<br>
                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
         </p>
            ...
            <div class="col-md-4">
               <div class="service-box wow fadeInDown animated"  >
                  ...
                  <h3 class="service-header">EDUCATION</h3>
                   <div class="service-line">
                           </div>
                  <p class="service-text" >Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
            ...
            <div class="col-md-4">
               <div class="service-box wow fadeInDown animated"   >
                  ...
                  <h3 class="service-header">SHELTER</h3>
                   <div class="service-line">
                           </div>
                  <p class="service-text" >Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
            ...
            <div class="col-md-4">
               <div class="service-box wow fadeInDown animated"  >
                  ...
                  <h3 class="service-header">EMPOWERMENT</h3>
                   <div class="service-line">
                           </div>
                  <p class="service-text" >Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
            ...
            <div class="col-md-4">
               <div class="service-box wow fadeInDown animated"  >
                  ...
                  <h3 class="service-header">BLOOD DONATION</h3>
                   <div class="service-line">
                           </div>
                  <p class="service-text" >Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
            ...
            <div class="col-md-4">
               <div class="service-box wow fadeInDown animated" >
                  ...
                  <h3 class="service-header">FOOD SUPPLY</h3>
                   <div class="service-line">
                           </div>
                  <p class="service-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
...
<section id="donars">
    <div class="container">
        <h1 class="quest-header">CO-FOUNDERS</h1>
         <div class="horizontal-line">
									<hr>
         </div>
         <p class="quest-paragraph" style="max-width: 950px;margin: 0 auto 50px;">Prochesta Foundation was founded by five dreamers, who were motivated by their wish to help the underprivileged people of the society. Without their effort, focus, talent and growth,
             running a social organization like Prochesta was unfeasible. They are our biggest inspiration
         </p>
           ...
           <div class="col-md-12 col-xs-12">
                <div id="owl-demo">
                          ...
                          <div class="item-container" >
                              <p class="donation-num"></p>
                                <figure class="team-member">
                                    <img src="img/Pavel Babu (Co-Founder).jpg" alt="">
                      ...
                      <div class="item">
                              <p class="donation-num"></p>
                                <figure class="team-member">
                                    <img src="img/Atisha rahber (co-founder).jpg" alt="">
                     ...
                     <div class="item">
                              <p class="donation-num"></p>
                                <figure class="team-member">
                                    <img src="img/Tanvir Tamal Setu (co-founder).jpg" alt="">

                                <figcaption class="member-details text-center">
                                   <h5>TANVIR TAMAL SETU</h5>
                                    <p>Co-founder</p>
                                </figcaption>
                            </figure>
                      </div>
                      <div class="item">
                              <p class="donation-num"></p>
                                <figure class="team-member">
                                    <img src="img/Rakib Ridat ( CO-founder(.jpg" alt="">
                      ...
                      <div class="item">
                          <div class="item-container" >
                              <p class="donation-num"></p>
                                <figure class="team-member">
                                    <img src="img/Shorif Islam Khan (co-founder).jpg" alt="">

                                <figcaption class="member-details text-center">
                                   <h5>SHORIF ISLAM KHAN</h5>
                                    <p>Co-founder</p>
                                </figcaption>
                            </figure>
                         </div>
...
<section id="students" style="padding:30px 0px 170px">
        <div class="container">
            <h1 class="quest-header">SOME OF OUR STUDENTS</h1>
         <div class="horizontal-line">
									<hr>
         </div>
         <p class="quest-paragraph" style="max-width: 750px;margin: 0 auto 50px;">Our children are very much “tomorrow's leaders”; everyday, they are learning ... Today, our students can be the leaders of their own education, & we are always here with them
         </p>
           <div class="row no-gutters">
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 student">
                  ...
                  <figure class="student-img">
                     <img src="img/Mohammad Jasim.jpg" alt="">
                  </figure>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 student">
                  ...
                  <figure class="student-img">
                     <img src="img/Sadia Akter.jpg" alt="">
                  </figure>
                <div class="student-details" style="">
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 student">
                  ...
                  <p class="student-name" >MOHAMMAD JASIM</p>
                  <figure class="student-img">
                     <img src="img/Rajon Islam.jpg" alt="">
                  </figure>
                <div class="student-details" style="">
         ...
         <p class="quest-paragraph" style="margin-bottom:0px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod<br>
          ...
          <div class="row text-center wow fadeInDown">
                  <aside class="col-md-3 col-sm-3 col-xs-12  sponsor wow tada" >
                   ...
                   <aside class="col-md-3 col-sm-3 col-xs-12  sponsor wow tada" >
                      <img src="img/sponsor4.png" style="width:160px;height:52px" alt="">
                  </aside>
